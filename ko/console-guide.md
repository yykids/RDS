...
* DB 인스턴스 생성시 DB 파일 암호화 기능을 사용하면, 이 인스턴스로부터 복원이나 복제시 DB 파일 암호화 기능을 끌 수 없습니다.
* DB 인스턴스 생성시 DB 파일 암호화 기능을 선택하지 않았을 때, 이 인스턴스로부터 복원이나 복제시 DB 파일 암호화 기능을 켤 수 없습니다.
