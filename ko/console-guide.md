...
> [참고] 고가용성 인스턴스 사용 시, mysql 쿼리문을 사용해 다른 인스턴스 또는 외부 mysql의 master를 바라보도록 강제로 복제를 설정할 경우, 고가용성 및 일부 기능들이 정상적으로 동작하지 않습니다.
...
> [참고] MySQL 5.7 이상의 버전의 경우, 백업 중에 인덱스 생성 및 rebuild를 수행하면 백업이 실패합니다.
